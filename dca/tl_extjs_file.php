 ...
 * Table tl_extjs_file
 */
$GLOBALS['TL_DCA']['tl_extjs_file'] = array
(
	...
	(
		...
		(
			...
			'child_record_callback' => array('tl_extjs_file', 'listJsFiles'),
	...
	(
		...
		(
			...
			'exclude'   => true,
			'inputType' => 'fileTree',
			'eval'      => array('fieldType' => 'radio', 'filesOnly' => true, 'mandatory' => true, 'extensions' => 'js', 'path' => '/'),
