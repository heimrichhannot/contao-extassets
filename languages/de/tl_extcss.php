...
$GLOBALS['TL_LANG']['tl_extcss']['bootstrapResponsiveDevices'] = array('Unterstütze Geräte', 'Folgende Geräte werden unterstützt.');
...
$GLOBALS['TL_LANG']['tl_extcss']['edit']   = array('Gruppe bearbeiten ', 'Bearbeiten der Gruppe ID %s');
...
$GLOBALS['TL_LANG']['tl_extcss']['devices']['large'] = 'Große Monitore (1200px+)';
$GLOBALS['TL_LANG']['tl_extcss']['devices']['tablet'] = 'Tablets';
$GLOBALS['TL_LANG']['tl_extcss']['devices']['phone'] = 'Smartphones';